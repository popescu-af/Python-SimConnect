...
class AircraftRequests():
	...
	class __AircraftFlightInstrumentationData(RequestHelper):
		list = {
			"AUTOPILOT_SPEED_SLOT_INDEX": ["Autopilot speed slot index", b'AUTOPILOT SPEED SLOT INDEX', b'Number', 'N'],
			"AUTOPILOT_HEADING_SLOT_INDEX": ["Autopilot heading slot index", b'AUTOPILOT HEADING SLOT INDEX', b'Number', 'N'],
			"AUTOPILOT_ALTITUDE_SLOT_INDEX": ["Autopilot altitude slot index", b'AUTOPILOT ALTITUDE SLOT INDEX', b'Number', 'N'],
			"AUTOPILOT_VS_SLOT_INDEX": ["Autopilot vertical speed slot index", b'AUTOPILOT VS SLOT INDEX', b'Number', 'N'],
